...
public class RunKApprox {
    ...
    public static void main(String args[]){
        ...
        ArrayList<ArrayList<Integer>> pivot_result = KApprox.KApproxAlg(prob_matrix, k);
        ...
        ArrayList<ArrayList<Integer>> fill_result = pivot_result; // PTAS.maxAgree(prob_matrix, k, sample_size, 0.75);
        ...
        ArrayList<ArrayList<Integer>> rand_result = pivot_result; //  PTAS.maxAgree(prob_matrix, k, sample_size, 0.5);
        ...
        ArrayList<ArrayList<Integer>> blend_result = pivot_result; // PTAS.maxAgree(prob_matrix, k, sample_size, 0.25);
        ...
        System.out.println("KApprox times: ");
        for (int i = 0; i < ROUNDS; i++)
            System.out.print(pivotTimes[i] + " ");
        System.out.println();
        System.out.println();
        System.out.println("KApprox scores: ");
        for (int i = 0; i < ROUNDS; i++)
        ...
        */
        ...
        System.out.println("Average KApprox time: " + pivotTimeTotal / ((double) ROUNDS));
        ...
        System.out.println();
        System.out.println("Average KApprox score: " + pivotScoreTotal / ((double) ROUNDS));
	...
	//System.out.println("Average MinDisagree score: " + hybridScoreTotal / ((double) ROUNDS));
        System.out.println();
        System.out.println("Average KApprox num clusters: " + pivotNumClusters / ((double) ROUNDS));
        ...
        System.out.println();
        System.out.println("Average KApprox max cluster size: " + largestPivotCluster / ((double) ROUNDS));
