...
public class RunPTAS {
    ...
    public static void main(String args[]){
        ...
        ArrayList<ArrayList<Integer>> pivot_result = PTAS.minDisagree(prob_matrix, k, sample_size);
        ...
        */
        ...
        System.out.println("Average MinDisagree time: " + pivotTimeTotal / ((double) ROUNDS));
        ...
        System.out.println();
        System.out.println("Average MinDisagree score: " + pivotScoreTotal / ((double) ROUNDS));
	...
	//System.out.println("Average MinDisagree score: " + hybridScoreTotal / ((double) ROUNDS));
        System.out.println();
        System.out.println("Average MinDisagree num clusters: " + pivotNumClusters / ((double) ROUNDS));
        ...
        System.out.println();
        System.out.println("Average MinDisagree max cluster size: " + largestPivotCluster / ((double) ROUNDS));
