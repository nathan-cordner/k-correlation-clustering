...
public class RunTimedBlend {
	...
	ArrayList<ArrayList<Integer>> cur_clustering = PKwik.k_pivotBlend(prob_matrix, k);
	long initialTime = System.currentTimeMillis() - initial;
        ...
        // ArrayList<ArrayList<Integer>> cur_clustering = PKwik.k_pivotBlend(prob_matrix, k);
        ArrayList<ArrayList<Integer>> pivot_result = KLocalSearch.k_local_search_network_timed(prob_matrix, cur_clustering, k, pivotStart, twoMinuteLimit);
        ...
        // cur_clustering = PKwik.k_pivotBlend(prob_matrix, k);
        ArrayList<ArrayList<Integer>> fill_result = KLocalSearch.k_local_search_network_timed(prob_matrix, copy1, k, fillStart, fiveMinuteLimit);
        ...
        // cur_clustering = PKwik.k_pivotBlend(prob_matrix, k);
        ArrayList<ArrayList<Integer>> rand_result = KLocalSearch.k_local_search_network_timed(prob_matrix, copy2, k, randStart, tenMinuteLimit);
